export const Banner1 = () => {
  return (
    <>
      <div className="w-full h-32 bg-interview-100 rounded-lg flex mb-9 relative overflow-hidden">
        <div className="flex flex-col justify-center ml-8">
          ...
          <h2 className="text-base font-normal dark:text-slate-800">
            취약계층 해외연수 지원 사업으로,
            <br />
            어려운 환경에도 불구하고 자기개발과 진로개척에 꿈과 열정을 지닌
            대학생에게 해외연수 경험을 지원하는 국고 지원 사업이다.
          </h2>
        </div>
      </div>
    </>
    ...
    <>
      <div className="w-full h-32 bg-interview-100 rounded-lg flex mb-9 relative ">
        <div className="flex flex-col justify-center ml-8">
          ...
          <h2 className="text-base font-normal dark:text-slate-800">
            {`본교에서 일정 조건의 학점을 충족하고 (졸업학점의 1/2 이상) 상대교에서 남은 학점을 이수한 후,\n양교에서 이수한 학점이 상호 인정되어 양교의 졸업요건을 모두 충족했을 시 본교와 상대교의 2개의 학위(Dual Degree)를 모두 취득하는 프로그램이다.`}
          </h2>
        </div>
      </div>
    </>
...
프로그램 비용 중 일부를 장학금으로 지원받으며, 파견기간 중 수학한 과목의 교육 시간에 따라 파견 계절학기 학점으로 인정한다.`}
        </h2>
      </div>
    </div>
  );
  ...
  return (
    <div className="w-full h-32 bg-interview-100 rounded-lg flex mb-9 relative ">
      <div className="flex flex-col justify-center ml-8">
        ...
        <h2 className="text-base font-normal dark:text-slate-800">{`선배 조언 ㅇㅇ`}</h2>
      </div>
    </div>
  );
};
