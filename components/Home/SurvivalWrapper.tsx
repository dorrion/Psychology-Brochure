  ...
  return (
    <>
      <div className="xl:w-1/4 lg:w-1/3 md:w-1/2 p-4">
        <div className="h-full dark:bg-slate-700 bg-gray-50 overflow-hidden relative">
          <Link href="/post/[id]" as={`/post/${tipId}`}>
            ...
            <div className="p-4 mb-4 md:mb-8">
              ...
              <h1 className="whitespace-pre title-font text-lg font-medium text-gray-900 mb-3">
                {title}
              </h1>
