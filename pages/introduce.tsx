      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-12 mx-auto">
          ...
          <section>
            ...
            <p className="my-6"> 안녕하세요. 구르는 감자단입니다.</p>
            <p className="my-6">
              아주대 심리학과는 다양한 진로를 선택할 수 있다는 장점이 있는 만큼,
              다양한 선택을 하면서 학과생활을 할 수 있다고 느끼고 있습니다.
              다양한 길과 선택이 있다는 것은 스스로 정해야하는 미지의 미래가
              그만큼 많다는 것이며, 그 미래를 두려워하지 않고 즐기는 것은 어려운
              일이라 생각합니다. 어떠한 선택을 정답이라 확신하고 나아가는 것만큼
              위험한 것은 없지만 그 선택을 두려워하지 않을 수만 있다면 좋겠다는
              생각을 해왔습니다. 우리의 미래를 위해서 지금 우리가 무엇을
              해야하는지, 어떤 수업을 듣고, 어떤 활동을 해야하는지 늘
              고민합니다.
            </p>
            <p className="my-6">
              ...
              함께 각각의 진로에 맞는 추천 커리큘럼/요람을 만들어 누구나 열람을
              할 수 있도록 배포하고자 이 활동을 시작했습니다.
            </p>
            <p className="my-6">
              활동을 하면서 많은 분들의 이야기들을 들을 수 있었고 덕분에
              요람까지 이어질 수 있었던 것 같습니다. 방대한 양의 정보들은
              아니라더라도 하나하나의 소중하디 소중한 이야기를 담았습니다. 부디
              이 이야기의 전달이 도움이 되길 바랍니다. 다만, 이 요람의 이야기가
              유일한 길이며 정답이라고 생각하지 않았으면 좋겠습니다. 모든
              이야기들은 선례일 뿐이며, 새로운 길이 발견될 수도 있습니다.
